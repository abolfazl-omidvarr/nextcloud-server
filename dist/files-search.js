...
function init() {
  ...
  _logger_ts__WEBPACK_IMPORTED_MODULE_4__["default"].info('Initializing unified search plugin: folder search from files app');
    ...
    callback: (showFilePicker = true) => {
      if (showFilePicker) {
        const filepicker = (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_0__.getFilePickerBuilder)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)('files', 'Pick folder to search in')).setNoMenu(true).addMimeTypeFilter('httpd/unix-directory').allowDirectories(true).addButton({
          label: 'Pick',
          callback: nodes => {
            _logger_ts__WEBPACK_IMPORTED_MODULE_4__["default"].info('Folder picked', {
              folder: nodes[0]
            });
        ...
        _logger_ts__WEBPACK_IMPORTED_MODULE_4__["default"].debug('Folder search callback was handled without showing the file picker, it might already be open');
      }
    }
  });
}
...
/******/ })()
;
//# sourceMappingURL=files-search.js.map?v=cf327a90990068ad85ef