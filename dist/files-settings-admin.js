...
/* harmony import */ var _models_SanitizeFilenameStatus_ts__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../models/SanitizeFilenameStatus.ts */ "./apps/files/src/models/SanitizeFilenameStatus.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  setup(__props) {
    ...
    const isRunning = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(() => status.value === _models_SanitizeFilenameStatus_ts__WEBPACK_IMPORTED_MODULE_12__.SanitizeFilenameStatus.Scheduled || status.value === _models_SanitizeFilenameStatus_ts__WEBPACK_IMPORTED_MODULE_12__.SanitizeFilenameStatus.Running);
    /**
    ...
    async function startSanitization() {
      ...
      try {
        ...
        status.value = _models_SanitizeFilenameStatus_ts__WEBPACK_IMPORTED_MODULE_12__.SanitizeFilenameStatus.Scheduled;
      } catch (error) {
        _logger_ts__WEBPACK_IMPORTED_MODULE_11__["default"].error('Failed to start filename sanitization.', {
          error
        });
    ...
    async function refreshStatus() {
      ...
      try {
        ...
        _logger_ts__WEBPACK_IMPORTED_MODULE_11__["default"].error('Failed to refresh filename sanitization status.', {
          error
        });
    ...
    return {
      ...
      SanitizeFilenameStatus: _models_SanitizeFilenameStatus_ts__WEBPACK_IMPORTED_MODULE_12__.SanitizeFilenameStatus
    };
  }
}));
  ...
  setup(__props) {
    ...
    async function toggleWindowsFilenameSupport(enabled) {
      ...
      try {
        ...
        _logger_ts__WEBPACK_IMPORTED_MODULE_9__["default"].error('Failed to toggle Windows filename support', {
          error
        });
      } finally {
        loading.value = false;
...
/******/ })()
;
//# sourceMappingURL=files-settings-admin.js.map?v=3f2757be8f83f0183059