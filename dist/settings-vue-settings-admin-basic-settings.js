...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    async onProfileDefaultChange(isEnabled) {
      if ((0,_utils_validate_js__WEBPACK_IMPORTED_MODULE_5__.validateBoolean)(isEnabled)) {
        await this.updateProfileDefault(isEnabled);
      }
    },
    async updateProfileDefault(isEnabled) {
      try {
        const responseData = await (0,_service_ProfileService_js__WEBPACK_IMPORTED_MODULE_4__.saveProfileDefault)(isEnabled);
        this.handleResponse({
          isEnabled,
    ...
    handleResponse({
      ...
      if (status === 'ok') {
        ...
        _logger_ts__WEBPACK_IMPORTED_MODULE_3__["default"].error(errorMessage, error);
      }
    }
  }
});
...
/******/ })()
;
//# sourceMappingURL=settings-vue-settings-admin-basic-settings.js.map?v=4a731fad73b561cb8d5d