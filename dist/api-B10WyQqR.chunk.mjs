...
import { g as getLoggerBuilder, i as emit } from "./mdi-CCQ2KgUK.chunk.mjs";
...
async function fetchTags() {
  ...
  try {
    ...
    throw new Error(translate("systemtags", "Failed to load tags"));
  }
}
async function fetchTag(tagId) {
  ...
  try {
    ...
    throw new Error(translate("systemtags", "Failed to load tag"));
  }
}
async function createTag(tag) {
  ...
  try {
    ...
    if (error?.response?.status === 409) {
      ...
      throw new Error(translate("systemtags", "A tag with the same name already exists"));
    }
    logger.error(translate("systemtags", "Failed to create tag"), { error });
    throw new Error(translate("systemtags", "Failed to create tag"));
  }
}
async function updateTag(tag) {
  ...
  try {
    ...
    throw new Error(translate("systemtags", "Failed to update tag"));
  }
}
async function deleteTag(tag) {
  ...
  try {
    ...
    throw new Error(translate("systemtags", "Failed to delete tag"));
  }
}
...
//# sourceMappingURL=api-B10WyQqR.chunk.mjs.map
