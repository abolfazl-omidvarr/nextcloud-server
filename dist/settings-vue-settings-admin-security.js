...
/* harmony import */ var lodash_debounce_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(lodash_debounce_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var lodash_sortedUniq_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! lodash/sortedUniq.js */ "./node_modules/lodash/sortedUniq.js");
/* harmony import */ var lodash_sortedUniq_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(lodash_sortedUniq_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var lodash_uniq_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! lodash/uniq.js */ "./node_modules/lodash/uniq.js");
/* harmony import */ var lodash_uniq_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(lodash_uniq_js__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted() {
    ...
    this.groups = lodash_sortedUniq_js__WEBPACK_IMPORTED_MODULE_4___default()(lodash_uniq_js__WEBPACK_IMPORTED_MODULE_5___default()(this.enforcedGroups.concat(this.excludedGroups)));
  ...
  methods: {
    searchGroup: lodash_debounce_js__WEBPACK_IMPORTED_MODULE_3___default()(function (query) {
      this.loadingGroups = true;
      _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].get((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_2__.generateOcsUrl)('cloud/groups?offset=0&search={query}&limit=20', {
        query
      })).then(res => res.data.ocs).then(ocs => ocs.data.groups).then(groups => {
        this.groups = lodash_sortedUniq_js__WEBPACK_IMPORTED_MODULE_4___default()(lodash_uniq_js__WEBPACK_IMPORTED_MODULE_5___default()(this.groups.concat(groups)));
      }).catch(error => _logger_ts__WEBPACK_IMPORTED_MODULE_10__["default"].error('could not search groups', {
        error
      })).then(() => {
    ...
    saveChanges() {
      ...
      _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].put((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_2__.generateUrl)('/settings/api/admin/twofactorauth'), data).then(resp => resp.data).then(state => {
        this.state = state;
        this.dirty = false;
      }).catch(error => {
        _logger_ts__WEBPACK_IMPORTED_MODULE_10__["default"].error('could not save changes', {
          error
        });
      }).then(() => {
        this.loading = false;
...
/******/ })()
;
//# sourceMappingURL=settings-vue-settings-admin-security.js.map?v=90af13a6458b88fe7152