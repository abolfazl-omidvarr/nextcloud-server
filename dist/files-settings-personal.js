...
const picker = (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.getFilePickerBuilder)(t('files', 'Choose a file or folder to transfer')).setMultiSelect(false).setType(1).allowDirectories().build();
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created() {
    this.findUserDebounced = (0,debounce__WEBPACK_IMPORTED_MODULE_3__["default"])(this.findUser, 300);
    this.findUser('');
  },
  methods: {
    start() {
      ...
      picker.pick().then(dir => dir === '' ? '/' : dir).then(dir => {
        ...
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.showError)(this.directoryPickerError);
      });
    },
    async findUser(query) {
      ...
      try {
        ...
        response.data.ocs.data.exact.users.concat(response.data.ocs.data.users).forEach(user => {
          vue__WEBPACK_IMPORTED_MODULE_4__["default"].set(this.userSuggestions, user.value.shareWith, {
    ...
    submit() {
      ...
      _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(url, data).then(resp => resp.data).then(data => {
        ...
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.showSuccess)(t('files', 'Ownership transfer request sent'));
      }).catch(error => {
        ...
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.showError)(this.submitError);
      });
    }
  }
});
...
/******/ })()
;
//# sourceMappingURL=files-settings-personal.js.map?v=9a66801dce6642e121c1