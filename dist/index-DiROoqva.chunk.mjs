...
import { s as scopedGlobals, l as logger } from "./public-SXOFh1vA.chunk.mjs";
import { J as commonjsGlobal, B as process$1, t as getDefaultExportFromCjs } from "./mdi-CCQ2KgUK.chunk.mjs";
import { a as requireDist, r as requireString_decoder, B as Buffer } from "./string_decoder-CSsspFHV.chunk.mjs";
...
function checkOptionalProperty(obj, property, type2) {
  if (typeof obj[property] !== "undefined") {
    if (type2 === "array") {
      if (!Array.isArray(obj[property])) {
        throw new Error(`View ${property} must be an array`);
      }
    } else if (typeof obj[property] !== type2) {
      throw new Error(`View ${property} must be a ${type2}`);
    } else if (type2 === "object" && (obj[property] === null || Array.isArray(obj[property]))) {
...
export {
  ...
  DefaultType as D,
  View as V,
  registerFileListAction as a,
  registerFileAction as b,
  registerSidebarAction as c,
  formatFileSize as f,
  getNavigation as g,
  registerSidebarTab as r
};
//# sourceMappingURL=index-DiROoqva.chunk.mjs.map
