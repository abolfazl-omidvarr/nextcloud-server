  ...
  setup(__props, {
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.onMounted)(async () => {
      try {
        ...
        _logger_ts__WEBPACK_IMPORTED_MODULE_4__["default"].debug('Aborted picking nodes:', {
          error
        });
        emit('cancel');
      }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_5__.defineComponent)({
  ...
  mounted() {
    if (this.richObject['preview-available']) {
      ...
      img.onerror = error => {
        _logger_ts__WEBPACK_IMPORTED_MODULE_9__["default"].error('could not load recommendation preview', {
          error
        });
      };
      img.src = previewUrl;
...
/******/ })()
;
//# sourceMappingURL=files-reference-files.js.map?v=adc21993ac7cee0bd0eb