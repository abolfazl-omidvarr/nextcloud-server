...
/* harmony import */ var _logger_ts__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../logger.ts */ "./apps/settings/src/logger.ts");
...
/* harmony import */ var _store_index_js__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../store/index.js */ "./apps/settings/src/store/index.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  setup(__props) {
    const store = (0,_store_index_js__WEBPACK_IMPORTED_MODULE_18__.useStore)();
    ...
    async function loadGroups() {
      ...
      try {
        ...
        _logger_ts__WEBPACK_IMPORTED_MODULE_16__["default"].error((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_3__.t)('settings', 'Failed to load groups'), {
          error
        });
      }
...
/* harmony import */ var vue_router_composables__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! vue-router/composables */ "./node_modules/vue-router/composables.mjs");
...
/* harmony import */ var _nextcloud_vue_components_NcAppNavigationNew__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @nextcloud/vue/components/NcAppNavigationNew */ "./node_modules/@nextcloud/vue/dist/Components/NcAppNavigationNew.mjs");
...
/* harmony import */ var _nextcloud_vue_components_NcCounterBubble__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @nextcloud/vue/components/NcCounterBubble */ "./node_modules/@nextcloud/vue/dist/Components/NcCounterBubble.mjs");
...
/* harmony import */ var _components_Users_UserSettingsDialog_vue__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../components/Users/UserSettingsDialog.vue */ "./apps/settings/src/components/Users/UserSettingsDialog.vue");
/* harmony import */ var _composables_useGroupsNavigation_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../composables/useGroupsNavigation.js */ "./apps/settings/src/composables/useGroupsNavigation.ts");
/* harmony import */ var _store_index_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../store/index.js */ "./apps/settings/src/store/index.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  setup(__props) {
    const route = (0,vue_router_composables__WEBPACK_IMPORTED_MODULE_3__.useRoute)();
    const store = (0,_store_index_js__WEBPACK_IMPORTED_MODULE_14__.useStore)();
    ...
    const {
      ...
      recentGroup,
      disabledGroup
    } = (0,_composables_useGroupsNavigation_js__WEBPACK_IMPORTED_MODULE_13__.useFormatGroups)(groups);
    /** Server settings for current user */
    const settings = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(() => store.getters.getServerData);
    /** True if the current user is a (delegated) admin */
    const isAdminOrDelegatedAdmin = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(() => settings.value.isAdmin || settings.value.isDelegatedAdmin);
    ...
    return {
      ...
      NcAppNavigationNew: _nextcloud_vue_components_NcAppNavigationNew__WEBPACK_IMPORTED_MODULE_7__["default"],
      NcButton: _nextcloud_vue_components_NcButton__WEBPACK_IMPORTED_MODULE_8__["default"],
      NcCounterBubble: _nextcloud_vue_components_NcCounterBubble__WEBPACK_IMPORTED_MODULE_9__["default"],
      NcIconSvgWrapper: _nextcloud_vue_components_NcIconSvgWrapper__WEBPACK_IMPORTED_MODULE_10__["default"],
      AppNavigationGroupList: _components_AppNavigationGroupList_vue__WEBPACK_IMPORTED_MODULE_11__["default"],
      UserSettingsDialog: _components_Users_UserSettingsDialog_vue__WEBPACK_IMPORTED_MODULE_12__["default"]
    };
  }
}));
...
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.runtime.esm.js");
/* harmony import */ var vue_frag__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! vue-frag */ "./node_modules/vue-frag/dist/frag.esm.js");
...
/* harmony import */ var _Users_NewUserDialog_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Users/NewUserDialog.vue */ "./apps/settings/src/components/Users/NewUserDialog.vue");
/* harmony import */ var _Users_UserListFooter_vue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Users/UserListFooter.vue */ "./apps/settings/src/components/Users/UserListFooter.vue");
/* harmony import */ var _Users_UserListHeader_vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Users/UserListHeader.vue */ "./apps/settings/src/components/Users/UserListHeader.vue");
/* harmony import */ var _Users_UserRow_vue__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./Users/UserRow.vue */ "./apps/settings/src/components/Users/UserRow.vue");
/* harmony import */ var _Users_VirtualList_vue__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./Users/VirtualList.vue */ "./apps/settings/src/components/Users/VirtualList.vue");
/* harmony import */ var _logger_ts__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../logger.ts */ "./apps/settings/src/logger.ts");
/* harmony import */ var _utils_userUtils_ts__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../utils/userUtils.ts */ "./apps/settings/src/utils/userUtils.ts");
...
const newUser = Object.freeze({
  ...
  manager: '',
  subAdminsGroups: [],
  quota: _utils_userUtils_ts__WEBPACK_IMPORTED_MODULE_14__.defaultQuota,
  language: {
    code: 'en',
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: 'UserList',
  components: {
    Fragment: vue_frag__WEBPACK_IMPORTED_MODULE_4__.Fragment,
    ...
    NewUserDialog: _Users_NewUserDialog_vue__WEBPACK_IMPORTED_MODULE_8__["default"],
    UserListFooter: _Users_UserListFooter_vue__WEBPACK_IMPORTED_MODULE_9__["default"],
    UserListHeader: _Users_UserListHeader_vue__WEBPACK_IMPORTED_MODULE_10__["default"],
    VirtualList: _Users_VirtualList_vue__WEBPACK_IMPORTED_MODULE_12__["default"]
  },
  props: {
    selectedGroup: {
      type: String,
  ...
  setup() {
    ...
    return {
      ...
      rowHeight: 55,
      UserRow: _Users_UserRow_vue__WEBPACK_IMPORTED_MODULE_11__["default"]
    };
  },
  data() {
    return {
  ...
  computed: {
    ...
    hasObfuscated() {
      return this.filteredUsers.some(user => (0,_utils_userUtils_ts__WEBPACK_IMPORTED_MODULE_14__.isObfuscated)(user));
    },
    users() {
    ...
    quotaOptions() {
      ...
      if (this.settings.allowUnlimitedQuota) {
        quotaPreset.unshift(_utils_userUtils_ts__WEBPACK_IMPORTED_MODULE_14__.unlimitedQuota);
      }
      quotaPreset.unshift(_utils_userUtils_ts__WEBPACK_IMPORTED_MODULE_14__.defaultQuota);
      return quotaPreset;
    },
    usersOffset() {
  ...
  watch: {
    ...
    filteredUsers(filteredUsers) {
      _logger_ts__WEBPACK_IMPORTED_MODULE_13__["default"].debug(`${filteredUsers.length} filtered user(s)`);
    }
  },
  async created() {
    await this.loadUsers();
  ...
  methods: {
    ...
    async loadUsers() {
      ...
      try {
        ...
        _logger_ts__WEBPACK_IMPORTED_MODULE_13__["default"].debug(`${this.users.length} total user(s) loaded`);
      } catch (error) {
        _logger_ts__WEBPACK_IMPORTED_MODULE_13__["default"].error('Failed to load accounts', {
          error
        });
  ...
  methods: {
    ...
    async updatePassword() {
      ...
      if (this.editedPassword.length === 0) {
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.showError)(t('settings', "Password can't be empty"));
        ...
        try {
          ...
          this.editedPassword = '';
          (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.showSuccess)(t('settings', 'Password was successfully changed'));
        } finally {
          this.loading.password = false;
        }
      }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    quotaOptions() {
      ...
      // add default presets
      if (this.settings.allowUnlimitedQuota) {
        quotaPreset.unshift(_utils_userUtils_ts__WEBPACK_IMPORTED_MODULE_10__.unlimitedQuota);
      }
      return quotaPreset;
    },
    defaultQuota: {
      get() {
        ...
        if (this.settings.defaultQuota !== _utils_userUtils_ts__WEBPACK_IMPORTED_MODULE_10__.unlimitedQuota.id && OC.Util.computerFileSize(this.settings.defaultQuota) >= 0) {
          // if value is valid, let's map the quotaOptions or return custom quota
          return {
            id: this.settings.defaultQuota,
            label: this.settings.defaultQuota
    ...
    sendWelcomeMail: {
      ...
      async set(value) {
        try {
          ...
          _logger_ts__WEBPACK_IMPORTED_MODULE_9__["default"].error('Could not update newUser.sendEmail preference', {
            error
          });
        } finally {
...
var render = function render() {
  ...
  return _c("tr", {
    ...
    model: {
      ...
      callback: function ($$v) {
        _vm.editedPassword = $$v;
      },
      expression: "editedPassword"
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* reexport safe */ _chunks_NcAppNavigationSearch_CSih_quP_mjs__WEBPACK_IMPORTED_MODULE_0__.N)
/* harmony export */ });
/* harmony import */ var _chunks_NcAppNavigationSearch_CSih_quP_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../chunks/NcAppNavigationSearch-CSih_quP.mjs */ "./node_modules/@nextcloud/vue/dist/chunks/NcAppNavigationSearch-CSih_quP.mjs");
...
//# sourceMappingURL=settings-users-settings-users.js.map?v=2d1db92995f1cd0adf10