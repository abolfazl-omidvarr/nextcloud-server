...
/* harmony import */ var _convertUtils_ts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./convertUtils.ts */ "./apps/files/src/actions/convertUtils.ts");
/*!
...
function registerConvertActions() {
  ...
  const actions = convertProviders.map(({
    ...
    async exec({
      ...
      (0,_convertUtils_ts__WEBPACK_IMPORTED_MODULE_5__.convertFile)(nodes[0].fileid, to);
    ...
    async execBatch({
      ...
      (0,_convertUtils_ts__WEBPACK_IMPORTED_MODULE_5__.convertFiles)(fileIds, to);
      // Silently terminate, we'll handle the UI in the background
...
/* harmony import */ var _services_WebdavClient_ts__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../services/WebdavClient.ts */ "./apps/files/src/services/WebdavClient.ts");
/**
 * SPDX-FileCopyrightText: 2025 Nextcloud GmbH and Nextcloud contributors
 * SPDX-License-Identifier: AGPL-3.0-or-later
 */
...
async function convertFiles(fileIds, targetMimeType) {
  ...
  try {
    ...
    const newFiles = await Promise.all(newPaths.map(path => (0,_services_WebdavClient_ts__WEBPACK_IMPORTED_MODULE_7__.fetchNode)(path)));
...
async function convertFile(fileId, targetMimeType) {
  ...
  try {
    ...
    const newFile = await (0,_services_WebdavClient_ts__WEBPACK_IMPORTED_MODULE_7__.fetchNode)(result.data.ocs.data.path);
...
/* harmony import */ var _store_index_ts__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../store/index.ts */ "./apps/files/src/store/index.ts");
...
const action = {
  ...
  async exec({
    ...
    try {
      ...
      _logger_ts__WEBPACK_IMPORTED_MODULE_6__["default"].error('The requested file is not available.', {
        error
      });
  ...
  async execBatch({
    ...
    try {
      ...
      _logger_ts__WEBPACK_IMPORTED_MODULE_6__["default"].error('The requested files are not available.', {
        error
      });
...
function getCurrentDirectory(view, directory) {
  const filesStore = (0,_store_files_ts__WEBPACK_IMPORTED_MODULE_7__.useFilesStore)((0,_store_index_ts__WEBPACK_IMPORTED_MODULE_8__.getPinia)());
  const pathsStore = (0,_store_paths_ts__WEBPACK_IMPORTED_MODULE_9__.usePathsStore)((0,_store_index_ts__WEBPACK_IMPORTED_MODULE_8__.getPinia)());
  if (!view?.id) {
    return null;
  }
  if (directory === '/') {
...
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.runtime.esm.js");
/* harmony import */ var _logger_ts__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../logger.ts */ "./apps/files/src/logger.ts");
/* harmony import */ var _services_Files_ts__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../services/Files.ts */ "./apps/files/src/services/Files.ts");
...
const action = {
  ...
  async execBatch({
    ...
    try {
      ...
      _logger_ts__WEBPACK_IMPORTED_MODULE_11__["default"].error(`Failed to ${target.action} node`, {
        nodes,
        error
      });
...
async function* handleCopyMoveNodesTo(nodes, destination, method, overwrite = false) {
  ...
  if (!overwrite) {
    const otherNodes = (await (0,_services_Files_ts__WEBPACK_IMPORTED_MODULE_12__.getContents)(destination.path)).contents;
    ...
    for (const node of nodes) {
      ...
      yield queue.add(async () => {
        try {
          ...
          _logger_ts__WEBPACK_IMPORTED_MODULE_11__["default"].debug(`Error while trying to ${method === _moveOrCopyActionUtils_ts__WEBPACK_IMPORTED_MODULE_13__.MoveCopyAction.COPY ? 'copy' : 'move'} node`, {
            node,
            error
          });
...
async function openFilePickerForAction(action, dir = '/', nodes) {
  ...
  filePicker.pick().catch(error => {
    _logger_ts__WEBPACK_IMPORTED_MODULE_11__["default"].debug(error);
...
async function openLocalClient(path) {
  ...
  try {
    ...
    _logger_ts__WEBPACK_IMPORTED_MODULE_9__["default"].error('Failed to redirect to client', {
      error
    });
  }
}
...
const action = {
  ...
  enabled: ({
    ...
    return Boolean(node.permissions & _nextcloud_files__WEBPACK_IMPORTED_MODULE_2__.Permission.DELETE) && Boolean(parentPermissions & _nextcloud_files__WEBPACK_IMPORTED_MODULE_2__.Permission.CREATE);
  },
  async exec({
    nodes
  }) {
...
class TypeFilter extends _nextcloud_files__WEBPACK_IMPORTED_MODULE_1__.FileListFilter {
  ...
  setPresets(presets) {
    _logger_ts__WEBPACK_IMPORTED_MODULE_6__["default"].debug('TypeFilter: setting presets', {
      presets
    });
...
const entry = {
  ...
  async handler(context, content) {
    ...
    try {
      ...
      _logger_ts__WEBPACK_IMPORTED_MODULE_8__["default"].debug('Created new folder', {
        folder,
        source
      });
      ...
      _logger_ts__WEBPACK_IMPORTED_MODULE_8__["default"].error('Creating new folder failed', {
        error
      });
...
_logger_ts__WEBPACK_IMPORTED_MODULE_9__["default"].debug('Templates folder enabled', {
  templatesEnabled
});
_logger_ts__WEBPACK_IMPORTED_MODULE_9__["default"].debug('Initial templates folder', {
  templatesPath
});
/**
...
async function initTemplatesFolder(directory, name) {
  ...
  try {
    _logger_ts__WEBPACK_IMPORTED_MODULE_9__["default"].debug('Initializing the templates directory', {
      templatePath
    });
    const {
      data
    ...
    _logger_ts__WEBPACK_IMPORTED_MODULE_9__["default"].info('Created new templates folder', {
      ...data.ocs.data
    });
    templatesPath = data.ocs.data.templates_path;
  } catch (error) {
    _logger_ts__WEBPACK_IMPORTED_MODULE_9__["default"].error('Unable to initialize the templates directory', {
      error
    });
...
async function getContents(path = '/', options) {
  ...
  try {
    ...
    if (options.signal.aborted) {
      _logger_ts__WEBPACK_IMPORTED_MODULE_3__["default"].debug('Favorite nodes request was aborted');
      throw new DOMException('Aborted', 'AbortError');
    }
    _logger_ts__WEBPACK_IMPORTED_MODULE_3__["default"].error('Failed to load favorite nodes via WebDAV', {
      error
    });
    throw error;
  }
...
async function getContents(path = '/', options) {
  ...
  try {
    const contentsResponse = await _WebdavClient_ts__WEBPACK_IMPORTED_MODULE_6__.client.search('/', {
      signal: options.signal,
      details: true,
      data: (0,_nextcloud_files_dav__WEBPACK_IMPORTED_MODULE_2__.getRecentSearch)(lastTwoWeeksTimestamp)
    });
    ...
    if (options.signal.aborted) {
      _logger_ts__WEBPACK_IMPORTED_MODULE_3__["default"].info('Fetching recent files aborted');
      throw new DOMException('Aborted', 'AbortError');
    }
    _logger_ts__WEBPACK_IMPORTED_MODULE_3__["default"].error('Failed to fetch recent files', {
      error
    });
    throw error;
  }
...
async function registerFavoritesView() {
  ...
  const favoriteFolders = (await (0,_services_Favorites_ts__WEBPACK_IMPORTED_MODULE_6__.getContents)('', {
  ...
  _logger_ts__WEBPACK_IMPORTED_MODULE_5__["default"].debug('Generating favorites view', {
    favoriteFolders
  });
  ...
  (0,_nextcloud_event_bus__WEBPACK_IMPORTED_MODULE_2__.subscribe)('files:favorites:added', node => {
    ...
    if (node.path === null || !node.root?.startsWith('/files')) {
      _logger_ts__WEBPACK_IMPORTED_MODULE_5__["default"].error('Favorite folder is not within user files root', {
        node
      });
      return;
    }
...
/******/ })()
;
//# sourceMappingURL=files-init.js.map?v=269d55dc46d594dfb970